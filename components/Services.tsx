  ...
  const services = [
    {
      ...
      description:
        "Comprehensive health screenings and preventive care by our expert African medical professionals.",
      features: [
    ...
    },
    {
      ...
      description:
        "Expert consultations with African specialists across various medical fields and specialties.",
    ...
    },
    {
      ...
      description:
        "Secure digital prescription management with easy refills and medication tracking.",
      features: [
        "E-prescriptions",
    ...
    },
    {
      ...
      title: "Telemedicine",
      description:
        "Connect with our African healthcare professionals from anywhere through secure video consultations.",
      features: [
        "Video consultations",
        "24/7 availability",
        "Secure messaging",
    ...
    },
    {
      ...
      description:
        "Round-the-clock emergency medical services with rapid response from qualified African medical teams.",
      features: [
    ...
    },
    {
      ...
      description:
        "Continuous health monitoring and wellness programs designed by African health experts.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[hsl(210,25%,45%)] max-w-3xl mx-auto leading-relaxed">
            Experience excellence in African healthcare with our comprehensive
            range of medical services, delivered by skilled professionals
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="mb-6 leading-relaxed text-[hsl(210,25%,45%)]">
                {service.description}
              </p>
             ...
             bg-[hsl(185,60%,50%)] text-white shadow-md 
        ...
        <div className="text-center mt-16">
          ...
          >
            <h3 className="text-3xl font-bold mb-4">
              Ready to Experience African Healthcare Excellence?
            </h3>
            <p className="text-xl mb-8 text-[hsl(210,25%,45%)]">
              Join thousands of satisfied patients who trust our African medical
              professionals for their healthcare needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => (window.location.href = "/appointments")}
                className="px-8 py-4 rounded-xl font-semibold text-lg 
             bg-gradient-to-br from-[hsl(200,85%,45%)] to-[hsl(185,60%,50%)] 
             ...
             hover:shadow-xl hover:scale-105 cursor-pointer"
              ...
              <button
                onClick={() => (window.location.href = "/services")}
                className="px-8 py-4 rounded-xl font-semibold text-lg 
             bg-[hsl(210,15%,92%)] text-[hsl(210,50%,25%)] border-2 border-[hsl(200,85%,45%)] 
