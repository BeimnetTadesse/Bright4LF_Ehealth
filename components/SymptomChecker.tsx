...
const diseases: Disease[] = [
  ...
  const SymptomChecker = () => {
    ...
    const handleCheckSymptoms = () => {
      ...
      setResults(matched);
      setSearched(true); // show results or "No disease found" after search
    };
            ...
            {results.map((disease, idx) => (
              ...
              >
                ...
                <p className="mb-2 text-[hsl(210,25%,45%)]">
                  <span className="font-semibold">Symptoms:</span> {disease.symptoms.join(", ")}
                </p>
                <p className="text-[hsl(210,25%,45%)]">
                  <span className="font-semibold">Treatments:</span> {disease.treatments.join(", ")}
                </p>
              </div>
            ))}
          </div>
